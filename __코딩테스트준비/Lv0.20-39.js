...
function solution35(letter) {
  ...
  array = array.map(item => morse[item])
  return array.join('');
}

console.log('35',solution35(".... . .-.. .-.. ---"));
...
function solution36(rsp) {
  let array = rsp.split('');
  array = array.map(item => getRsp(item))
  return array.join('');
}
const getRsp = (n) => {
  switch (n){
...
function solution37(balls, share) {
...
function solution38(dot) {
  return dot[0] > 0 ? (dot[1] > 0 ? 1 : 4) : (dot[1] > 0 ? 2 : 3);
}

console.log('38',solution38([-7, 9]));
...
function solution39(num_list, n) {
  let answer = [];
...
console.log('39',solution39([100, 95, 2, 4, 5, 6, 18, 33, 948],3));
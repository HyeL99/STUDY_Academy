    ...
    jQuery.fn.ulslide = function(settings) {
        ...
        if (settings['statusbar']){
            ...
            if (settings['img_count']){
                thisObj.append('<li class="ulslide-statusbar" id="'+id+'-statusbar" style="position: absolute; padding:0; margin:0; width:'+settings['width']+'%; height:'+thisObj.css("height")+'; "><span>Loading...</span></li>');
            }
